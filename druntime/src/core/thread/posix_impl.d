...
private extern (C) bool thread_preSuspend( void* sp ) nothrow {
...
private extern (C) bool thread_postSuspend() nothrow {
    Thread obj = Thread.getThis();
    if (obj is null)
    {
        return false;
...
//TODO: private
package extern (C) void thread_suspendHandler( int sig ) nothrow
in
{
...
//TODO: private
package extern (C) void thread_resumeHandler( int sig ) nothrow
in
{
